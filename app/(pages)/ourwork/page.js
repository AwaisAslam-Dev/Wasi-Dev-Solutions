...
import clothestore from "@/public/clothestore.jpeg";
import dptdoctor from "@/public/dptdoctor.jpeg";
import ecommerce from "@/public/ecommerce.jpeg";
import restaurants from "@/public/restaurants.jpeg";
...
const WorkShow = () => {
  ...
  const projects = [
    {
      ...
      description:
        "Premium online store with seamless checkout, AI recommendations, and immersive shopping experience.",
      image: clothestore,
    ...
    },
    {
      ...
      category: "website",
      description:
        "Patient management system with appointment scheduling, telemedicine integration, and secure data handling.",
      image: dptdoctor,
    ...
    {
      id: 4,
      title: "Restaurant Odering Sytem",
      category: "seo",
      description:
        "Comprehensive SEO strategy that boosted organic traffic and local search visibility across 50+ locations.",
      image: restaurants,
      tags: ["SEO", "Node", "React", "Express","Mongodb"],
      liveUrl: "#",
      githubUrl: "#",
    },
    {
      ...
      category: "brand",
      description:
        "Complete brand identity including logo, design system, website, and marketing collateral for AI startup.",
      image: saas,
  ...
  return (
    <section
      className="relative min-h-screen py-16 sm:py-20 md:py-28 overflow-hidden bg-[#071026]"
      ref={sectionRef}
    >
      {/* Background Elements */}
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        {/* Hero Section */}
        <div
          className={`text-center mb-12 md:mb-16 ${isInView ? "fade-in-up" : "opacity-0"}`}
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#0D1328] border border-[#67D2FF]/20 mb-6 backdrop-blur-sm">
            ...
            <span className="text-sm text-[#67D2FF] font-medium">
              ✦ OUR PORTFOLIO
            </span>
          </div>
          ...
          <p className="text-[#B6BCC8] text-base sm:text-lg max-w-2xl mx-auto leading-relaxed px-4">
            ...
            businesses achieve their digital goals and stand out from the
            competition.
          </p>
        </div>
        ...
        {/* Stats Section */}
        <div
          className={`grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 mb-12 md:mb-16 stagger-projects ${isInView ? "" : "opacity-0"}`}
        >
          {stats.map((stat, index) => {
            ...
            return (
              <div
                key={index}
                className="stat-card text-center p-4 md:p-6 rounded-2xl bg-linear-to-br from-[#0D1328] to-[#071026] border border-[#67D2FF]/15 cursor-pointer"
              >
        ...
        {/* Projects Grid */}
        <div
          className={`grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8 stagger-projects ${isInView ? "" : "opacity-0"}`}
        >
          {filteredProjects.map((project) => (
            ...
            >
              {/* Project Image - Fixed for responsiveness */}
              <div className="relative w-full aspect-16/10 sm:aspect-video md:aspect-4/3 overflow-hidden bg-[#071026]">
                <Image
                  src={project.image}
                  alt={project.title}
                  fill
                  ...
                  quality={100}
                />
                <div className="absolute inset-0 bg-linear-to-t from-[#071026] via-[#071026]/40 to-transparent opacity-60" />

                {/* Overlay Links */}
                <div className="project-overlay absolute inset-0 bg-[#071026]/80 flex items-center justify-center gap-3 sm:gap-4 z-10">
                  <a
              ...
              <div className="p-4 sm:p-5 md:p-6">
                ...
                <div className="mb-2 sm:mb-3">
                  <h3 className="text-sm sm:text-base md:text-lg lg:text-xl font-bold text-white group-hover:text-[#67D2FF] transition-colors line-clamp-1">
                    {project.title}
                  </h3>
                </div>
                ...
                <div className="flex flex-wrap gap-1 sm:gap-1.5">
                  {project.tags.slice(0, 3).map((tag, idx) => (
                    <span
                      key={idx}
                      className="text-[8px] sm:text-[10px] px-1.5 sm:px-2 py-0.5 rounded-full bg-[#67D2FF]/10 text-[#67D2FF]"
                    >
                      {tag}
                    </span>
                  ))}
                  {project.tags.length > 3 && (
                    <span className="text-[8px] sm:text-[10px] px-1.5 sm:px-2 py-0.5 rounded-full bg-[#67D2FF]/10 text-[#8A92A6]">
                      +{project.tags.length - 3}
                    </span>
                  )}
                </div>
        ...
        {/* CTA Section */}
        <div
          className={`mt-12 md:mt-16 text-center ${isInView ? "fade-in-up" : "opacity-0"}`}
